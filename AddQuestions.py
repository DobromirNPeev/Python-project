...
class FourthRoundQuestion(AddQuestionMixin):
    ...
    def _create_interface(self):
        ...
        self.type_correct_answers=TextBoxForFiles(screen_width//2,screen_height//2+40,200,50,"answer(s)",self.data)
...
class FifthRoundQuestion(AddQuestionMixin):
    ...
    def _create_interface(self):
        ...
        self.type_correct_answer=TextBoxForFiles(screen_width//2,screen_height//2+40,200,50,"answer(s)",self.data)
        self.done=Button(screen_width//2-100,screen_height//2+200,200,50,"Done",lambda : self._save_data())
