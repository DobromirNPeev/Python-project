...
#Does not inherit from FirstRound because I don't want to depend on it
class FirstRoundMultiplayer(MultiplayerRound):
    ...
    def _create_interface(self):
        self.player_turn = Button(screen_width//2 - 140,screen_height//2 - 240,300,50,f"{self.current_player.name}'s turn",lambda: None)
